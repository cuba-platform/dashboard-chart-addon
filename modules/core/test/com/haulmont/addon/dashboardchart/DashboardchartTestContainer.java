...
package com.haulmont.addon.dashboardchart;
...
public class DashboardchartTestContainer extends TestContainer {

    public DashboardchartTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/addon/dashboardchart/app.properties",
    ...
    public static class Common extends DashboardchartTestContainer {

        public static final DashboardchartTestContainer.Common INSTANCE = new DashboardchartTestContainer.Common();
